...
QUEUE_URL = os.getenv('SMS_QUEUE_URL')

if not QUEUE_URL:
    print(" ERROR: SMS_QUEUE_URL no está configurado en .env")
    exit(1)
    ...
    try:
        ...
        if 'Messages' in response:
            for message in response['Messages']:
                ...
                print(f"\n Procesando envío de SMS...")
                time.sleep(2)  # Simular latencia de Twilio/SNS
